...
//            final Optional<Task> optionalTask = tasks.stream().filter(t -> t.getId() == taskId).findAny();
...
//        assertNull(savedTask.getEpicId(), "Эпик найден");
        ...
        void createEpicTest() {
           ...
           // final Optional<Epic> optionalTask = tasks.stream().filter(t -> t.getId() == epicId).findAny();
...
//            Epic epic = new Epic("Test addNewSubtask", "Test addNewSubtask description", NEW, 0, endTime);
//            final int epicId = taskManager.addEpic(epic);
...
//            final Optional<Subtask> optionalTask = tasks.stream().filter(t -> t.getId() == subTaskId).findAny();
...
//            final List<Subtask> subtaskList = taskManager.getEpicSubtasks(actual.getEpicId());
...
//            final int epicId = taskManager.addEpic(epic);
//            final LocalDateTime endTime = getLastEndTime();
//            Subtask subtask1 = new Subtask("Test", "Test description", NEW, epicId, 30, endTime);
//            taskManager.addSubtask(subtask1);
//            Subtask subtask2 = new Subtask("Test", "Test description", IN_PROGRESS, epicId, 60, subtask1.getEndTime());
